...
class TestNoofyDataDirOverride:
    def test_noofy_data_dir_overrides_base(self) -> None:
        ...
        assert paths.workflow_dashboard_overrides_dir == Path("/tmp/noofy-test/workflow-store/dashboard-overrides")
...
class TestEnsureDirectories:
    def test_ensure_directories_creates_writable_dirs(self, tmp_path: Path) -> None:
        ...
        assert paths.workflow_dashboard_overrides_dir.is_dir()
