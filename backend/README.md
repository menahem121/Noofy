...
- `COMFYUI_BOOTSTRAP_PYTHON_EXECUTABLE`: source-checkout Python used to create the managed ComfyUI virtual environment. Defaults to `python3`, but the executable must match the selected runtime profile ABI, currently Python 3.13.
