...
`backend/app/runtime/comfyui/comfyui_updates.py` owns the update, rebuild, repair,
...
- `backend/app/runtime/comfyui/comfyui_update_releases.py`: upstream release DTOs, GitHub release fetching,
  archive download IO, and stable release sorting.
- `backend/app/runtime/comfyui/comfyui_update_archive.py`: release archive extraction, archive-member path
  safety, and release tag normalization.
- `backend/app/runtime/comfyui/comfyui_update_records.py`: active/previous-active metadata, local validation
