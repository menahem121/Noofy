...
function OutputWidgetContent({
  ...
  const [previewVideo, setPreviewVideo] = useState<OutputVideoMedia | null>(null);
  ...
  useEffect(() => {
    if (previewVideo && !videoOutputs.some((video) => video.url === previewVideo.url)) {
      setPreviewVideo(null);
    }
  }, [previewVideo, videoOutputs]);
      ...
      <div className="widget-output-video">
        ...
        {previewVideo ? (
          <VideoPreviewViewer
            ...
            posterUrl={previewVideo.thumbnailUrl}
