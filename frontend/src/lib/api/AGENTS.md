...
| `jobs.ts` | Job/result/log types, per-output Gallery save status, and job API functions |
...
| `gallery.ts` | Mixed-media `GalleryItem`, render-time media URL helpers, and Gallery API functions |
