...
The shell prefers `backend/.venv`, then a local Python 3.11 on macOS, then `python3`. Use `NOOFY_BACKEND_PYTHON` to override the Python executable and `NOOFY_BACKEND_DIR` to override the backend directory.
